  ...
  <el-card shadow="never" class="border-0">
      ...
      <search @search="getData" @reset="resetSearchForm" :model="searchForm">
        ...
        <template #show>
          <search-item label="会员等级">
            <el-select v-model="searchForm.user_level" placeholder="请选择会员等级">
    ...
    <el-table :data="tableData" stripe style="width: 100%;" v-loading="loading">
      ...
      <el-table-column label="登录注册" align="center">
        <template #default="{ row }">
          <p v-if="row.list_login_time">
            最后登录{{ row.list_login_time }}
          </p>
          <p>
      ...
      <el-table-column label="操作" width="180" align="center">
        <template #default="scope">
          ...
          <div v-else>
            ...
            <el-popconfirm title="是否要删除该记录？" confirmButtonText="确认" cancelButtonText="取消" width="200px"
    ...
    <form-drawer ref="formDrawerRef" :title="noticeType" @submit="handleSubmit">
      <el-form :model="form" ref="formRef" :rules="rules" label-width="100px" :inline="false" class="w-[80%]">
        ...
        <el-form-item label="密码" prop="password" class="password-input">
          <el-input type="number" v-model="form.password" placeholder="请输入密码" show-password></el-input>
        </el-form-item>
...
<script setup>
import { ref } from 'vue';
import { getUserlList, updateUserStatus, createUser, updateUser, deleteUser } from '@/api/user.js';
