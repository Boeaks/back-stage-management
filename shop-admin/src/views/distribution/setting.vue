  ...
  <div v-loading="loading" class="bg-white p-4 rounded">
    <el-form :model="form" label-width="160px">
      ...
      <el-form-item label="结算时间">
        <div>
          <el-input v-model="form.settlement_days" placeholder="结算时间" style="width: 50%;" type="number">
      ...
      <el-form-item>
        <el-button type="primary" size="default" class="float-right mr-18" @click="submit">保存</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
