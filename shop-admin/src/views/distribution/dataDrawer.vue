<template>
    <el-drawer :title="drawerTitle" v-model="dialogVisible" destroy-on-close
        :size="tableData.length > 0 ? '70%' : '30%'">
        <!-- 搜索 -->
        <el-form :model="searchForm" size="small">
            ...
            <el-form-item label="开始时间">
                <el-date-picker v-model="searchForm.starttime" type="date" placeholder="开始日期" style="width: 65%;"
                    value-format="YYYY-MM-DD" />
            </el-form-item>
            <el-form-item label="结束时间">
                <el-date-picker v-model="searchForm.endtime" type="date" placeholder="结束日期" style="width: 65%;"
                    value-format="YYYY-MM-DD" />
            </el-form-item>
        ...
        <div v-else>
            <p class="flex justify-center text-gray-500">还未有推广信息噢，加吧劲！</p>
        </div>
